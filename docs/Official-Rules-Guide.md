...
- **Tracks and Boxes**:
  ...
  - **Event Deck Boxes**: Hold Event card decks for each player.
  - **Discard Piles**: Hold Event cards that have been played for each player.
  ...
  - **Turn and Phase Indicator**: Tracks the current turn and phase and current player.
  - **Cards played on table box**: Holds cards that are played on the table.
  - **Current action die**: Shows the current action die.
...
- **Shadow Dice**: 1 Character, 1 Army, 1 Muster, 1 Event, 1 Army/Muster, 1 Eye.
