...
/* renamed from: FreeStoryCard */
public class FreeStoryCard extends Card {
    ...
    public FreeStoryCard(Area startLoc, int index) {
        this(startLoc, (String) null, (String) null, (String) null);
        SetIndex(index);
    }

    FreeStoryCard(Area startLoc, String smallimg, String bigimg, String name) {
        super(startLoc, smallimg, bigimg, name);
    }

    FreeStoryCard(Area startLoc, String smallimg, String bigimg, String name, String newsmallback, String newbigback) {
        super(startLoc, smallimg, bigimg, name);
    ...
    public String type() {
        return Messages.getString("FreeStoryCard.0");
    }
